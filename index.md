...
Each blog post here will aim to build a “tree” of knowledge for the topic that each post covers. I’ve split up each post into sections that are parts of the tree: Roots - a background to place the topic into context, Trunk - core foundational knowledge - the need-to-know stuff, branches - start of some domain-specific knowledge. And with that, hopefully you’ll be empowered to go out there and build your own leaves on whatever piques your interest.
