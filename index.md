---
description: Accessible and conversational blog posts on software engineering topics
---

This is an accessible, easy to read, and conversational blog about various software engineering topics.
...
The people who will get the most out of this blog software engineers in mid-career who have bits and pieces of knowledge but want to tie it all together and motivated new grads who have started their jobs in software engineering. It's also for product managers who want more transparency around what the engineers on their team are working on. It’s someone who has some background already and is looking to get a more solid foundation and fill gaps in their knowledge.
...
I'll leave this huge **disclaimer** here: I really made this to be conversational blog about software engineering topics. I may be slightly inaccurate here or there, as one might be when they're just colloquially talking to you about a complicated topic. I've just written down what I've come across and what I know in a way that's hopefully accessible and easy to digest. So please don't read this blog with a critical eye, it's simply something that I'll hope you get a lot out of. I'll add a comment section on each post soon, where I invite you to please point out where I can flesh things out, correct or go into more detail. Just don't read this as something that's written in stone, or yell at me if something happens to be off. My goal is to paint with broad strokes, so you have a foundation that you can tweak and fine-tune as you continue on your learning journey.
